...
BADSTR	SSR	43		INVALID OPERAND MESSAGE
	LBRA	ABORT		GO HOME
...
SCAND1	SSR	19		DOES THIS ONE MATCH?
...
NXTDIR	LEAX	32,X		SKIP TO NEXT
	...
	SSR	26		DISPLAY
	SSR	25		DISPLLY MESSAGE
	FCCZ	' matches.'	
SEREND	CLRA			ZERO RETURN CODE
	BRA	ABORT		QUIT
NOMAT	SSR	44		FILE NOT FOUND
ABORT	SSR	0		GO HOME
