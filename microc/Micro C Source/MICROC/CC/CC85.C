 ...
 *
 * This program integrates the MCP, MCC85, MCO85, SLINK and ASM85
...
char htext[] = { "\n\
Use: CC85 <name> [-acdfiklmopqsx h= s= t=] [symbol=value]\n\n\
	...
	int *argv[];
{
	...
	message("DDS MICRO-C 8085 Cross Compiler v3.23\n");
...
noext:
	...
	*mptr = *ptr = 0;
	...
	if(link) {
		...
		sprintf(tail, "%s %s t=%s l=%s\\LIB85 -q%s%s",
