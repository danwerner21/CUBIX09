 ...
 *
 * This program integrates the MCP, MCC08, MCO08, SLINK and ASM08
...
char htext[] = { "\n\
Use: CC08 <name> [-acdfiklmopqsx h= s= t=] [symbol=value]\n\n\
	...
	int *argv[];
{
	...
	message("DDS MICRO-C 68HC08 Cross Compiler v3.23\n");
...
noext:
	...
	*mptr = *ptr = 0;
	...
	if(link) {
		...
		sprintf(tail, "%s %s t=%s l=%s\\LIB08 -q%s%s",
