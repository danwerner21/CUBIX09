 ...
 *
 * This program integrates the MCP, MCC96, MCO96, SLINK and ASM96
...
char htext[] = { "\n\
Use: CC96 <name> [-acdfiklmopqsx h= s= t=] [symbol=value]\n\n\
	...
	int *argv[];
{
	...
	message("DDS MICRO-C 8096 Cross Compiler v3.23\n");
...
noext:
	...
	*mptr = *ptr = 0;
	...
	if(link) {
		...
		sprintf(tail, "%s %s t=%s l=%s\\LIB96 -q -w%s%s",
