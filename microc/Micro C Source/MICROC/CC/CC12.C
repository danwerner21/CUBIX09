 ...
 *
 * This program integrates the MCP, MCC12, MCO12, SLINK and ASM12
...
char htext[] = { "\n\
Use: CC12 <name> [-acdfiklmopqsx h= s= t=] [symbol=value]\n\n\
	...
	int *argv[];
{
	...
	message("DDS MICRO-C 68HC12 Cross Compiler v3.23\n");
...
noext:
	...
	*mptr = *ptr = 0;
	...
	if(link) {
		...
		sprintf(tail, "%s %s t=%s l=%s\\LIB12 -q%s%s",
