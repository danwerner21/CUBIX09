 ...
 *
 * This program integrates the MCP, MCC11, MCO11, SLINK and ASM11
...
char htext[] = { "\n\
Use: CC11 <name> [-acdfiklmopqsx h= s= t=] [symbol=value]\n\n\
	...
	int *argv[];
{
	...
	message("DDS MICRO-C 68HC11 Cross Compiler v3.23\n");
...
noext:
	...
	*mptr = *ptr = 0;
	...
	if(link) {
		...
		sprintf(tail, "%s %s t=%s l=%s\\LIB11 -q%s%s",
