...
LA00E
        LDA     #$20
        STA     LINBUF
        LDS     #(LINBUF+LBUFMX)+1                  ; SET STACK TO TOP OF LINE INPUT BUFFER
...
LA093
        ...
        LEAX    STRING_SPACE_SIZE,X               ; CLEAR 3000 - DEFAULT STRING SPACE TO 3000 BYTES
...
L8031
        STU     ,X++                              ; STORE 'FC' ERROR AT USR ADDRESSES
        DECB                                      ; FINISHED ALL 10?
        BNE     L8031                             ; NO

        LDX     #LA147-1                          ; POINT X TO BASIC STARTUP MESSAGE
        JSR     LB99C                             ; PRINT STARTUP MESSAGE
...
BAWMST
        NOP                                       ; NOP REQ'D FOR WARM START
        JSR     LAD33                             ; DO PART OF A NEW
LA0F3
        JMP     LAC73                             ; GO TO MAIN LOOP OF BASIC
;*
...
;* COPYRIGHT MESSAGES
LA147
        FCC     "6809 EXTENDED BASIC FOR CUBIX"
        FCB     CR
...
LA37C
        STX     DEVCFW                            ; SAVE TAB FIELD WIDTH AND ZONE
...
LA39A
        JSR     LA171                             ; GO GET A CHARACTER FROM CONSOLE IN
        CMPA    #BS                               ; BACKSPACE
        BNE     LA3B4                             ; NO
...
LA3C8
        ...
        BNE     LA3D9                             ; NO
LA3CC
        CLRA                                      ; CLEAR CARRY FLAG IF ENTER KEY - END LINE ENTRY
LA3CD
...
;* EXEC
EXEC
        BEQ     LA545                             ; BRANCH IF NO ARGUMENT
...
;* INKEY$
INKEY
        LDA     IKEYIM                            ; WAS A KEY DOWN IN THE BREAK CHECK?
        BNE     LA56B                             ; YES
        JSR     KEYIN                             ; GO GET A KEY
LA56B
        CLR     IKEYIM                            ; CLEAR INKEY RAM IMAGE
...
LA5C9
        BEQ     LA5C4                             ; RETURN IF END OF LINE
...
LABF9
        LEAX    4,S                               ; POINT X TO 3RD ADDRESS ON STACK - IGNORE THE
;*         FIRST TWO RETURN ADDRESSES ON THE STACK
LABFB
        LDB     #18                               ; 18 BYTES SAVED ON STACK FOR EACH 'FOR' LOOP
...
LAC33
        CLRA                                      ; * ACCD CONTAINS NUMBER OF EXTRA
        ASLB                                      ; * BYTES TO PUT ON STACK
        ADDD    ARYEND                            ; END OF PROGRAM AND VARIABLES
LAC37
        ADDD    #STKBUF                           ; ADD STACK BUFFER - ROOM FOR STACK?
...
LAC73
        JSR     LB95C                             ; MOVE CURSOR TO START OF LINE
        LDX     #LABED                            ; POINT X TO 'OK', CR MESSAGE
        JSR     LB99C                             ; PRINT 'OK', CR
LAC7C
        JSR     LA390                             ; GO GET AN INPUT LINE
...
LACA5
        JSR     LAF67                             ; CONVERT LINE NUMBER TO BINARY
LACA8
        LDX     BINVAL                            ; GET CONVERTED LINE NUMBER
...
LACC0
        PULU    A                                 ; GET A BYTE FROM WHAT'S LEFT OF PROGRAM
        STA     ,X+                               ; MOVE IT DOWN
        CMPX    VARTAB                            ; COMPARE TO END OF BASIC PROGRAM
        BNE     LACC0                             ; BRANCH IF NOT AT END
LACC8
        LDA     LINBUF                            ; * CHECK TO SEE IF THERE IS A LINE IN
...
LACDD
        PULU    A                                 ; GET A BYTE FROM NEW LINE
...
LACE9
        BSR     LAD21                             ; RESET INPUT POINTER, CLEAR VARIABLES, INITIALIZE
...
LAD01
        LDD     BINVAL                            ; GET THE LINE NUMBER TO FIND
        LDX     TXTTAB                            ; BEGINNING OF PROGRAM
LAD05
        LDU     ,X                                ; GET ADDRESS OF NEXT LINE NUMBER
...
LAD12
        ORCC    #1                                ; SET CARRY FLAG
LAD14
        STX     V47                               ; SAVE MATCH LINE NUMBER OR NUMBER OF LINE JUST AFTER
...
;* NEW
NEW
        BNE     LAD14                             ; BRANCH IF ARGUMENT GIVEN
LAD19
...
LAD33
        LDX     #STRSTK                           ; * RESET STRING STACK POINTER TO
...
FOR
        LDA     #$80                              ; * SAVE THE DISABLE ARRAY FLAG IN VO8
...
LAD59
        LDB     #$09                              ; * CHECK FOR ROOM FOR 18 BYTES
...
LAD7F
        LDX     #LBAC5                            ; POINT X TO FLOATING POINT NUMBER 1.0 (DEFAULT STEP VALUE)
...
LAD90
        JSR     LBC6D                             ; CHECK STATUS OF FPA0
...
LADB1
        JMP     LB277                             ; 'SYNTAX ERROR'-IF NOT LINE SEPARATOR
LADB4
        LDA     ,X++                              ; GET MS BYTE OF ADDRESS OF NEXT BASIC LINE
...
LADC6
        BEQ     LADEA                             ; RETURN IF END OF LINE (RTS - was BEQ LAE40)
...
;* RESTORE
RESTOR
        LDX     TXTTAB                            ; BEGINNING OF PROGRAM ADDRESS
...
;* BREAK CHECK
LADEB
        JSR     LA1C1                             ; GET A KEYSTROKE ENTRY
        BEQ     LADFA                             ; RETURN IF NO INPUT
LADF0
        CMPA    #3                                ; CONTROL C? (BREAK)
        BEQ     STOP                              ; YES
...
LAE0B
        BNE     LAE40                             ; BRANCH IF ARGUMENT EXISTS
        LDX     CHARAD                            ; * SAVE CURRENT POSITION OF
        STX     TINPTR                            ; * BASIC'S INPUT POINTER
LAE11
        ROR     ENDFLG                            ; ROTATE CARRY INTO BIT 7 OF STOP/END FLAG
...
;* CONT
CONT
        BNE     LAE40                             ; RETURN IF ARGUMENT GIVEN
...
;* CLEAR
CLEAR
        BEQ     LAE6F                             ; BRANCH IF NO ARGUMENT
...
LAE5A
        TFR     X,D                               ; ACCD = TOP OF CLEARED SPACE
...
;* GO
GO
        TFR     A,B                               ; SAVE INPUT CHARACTER IN ACCB
LAE88
        JSR     GETNCH                            ; GET A CHARACTER FROM BASIC
...
;*              ; START OF PROGRAM
        LDX     TXTTAB                            ; BEGINNING OF PROGRAM
LAEB6
        JSR     LAD05                             ; GO FIND A LINE NUMBER
        BCS     LAED2                             ; 'UNDEFINED LINE NUMBER'
LAEBB
        LEAX    -1,X                              ; MOVE BACK TO JUST BEFORE START OF LINE
        STX     CHARAD                            ; RESET BASIC'S INPUT POINTER
LAEBF
        RTS
;*
;* RETURN
RETURN
        BNE     LAEBF                             ; EXIT ROUTINE IF ARGUMENT GIVEN
...
LAEF7
        ...
        CMPA    #$22                              ; CHECK FOR DOUBLE QUOTES
...
LAF22
        LDA     FP0EXP                            ; CHECK FOR TRUE/FALSE - FALSE IF FPA0 EXPONENT = ZERO
...
LAF28
        BSR     DATA                              ; MOVE BASIC'S POINTER TO END OF SUBLINE
...
LAF52
        LBNE    LAED7                             ; 'SYNTAX' ERROR IF NOT 'SUB' OR 'TO'
LAF54
        DEC     FPA0+3                            ; DECREMENT IS BYTE OF MANTISSA OF FPA0 - THIS
...
;* TARGET = REPLACEMENT
LET
        JSR     LB357                             ; FIND TARGET VARIABLE DESCRIPTOR
...
LAFA4
        LDX     FPA0+2                            ; POINT X TO DESCRIPTOR OF REPLACEMENT STRING
...
LAFBE
        STX     V4D                               ; SAVE STRING DESCRIPTOR ADDRESS IN V4D
...
LAFCF
        FCC     "?REDO"                           ; ?REDO MESSAGE
        FCB     CR,$00

LAFD6
LAFDC
        JMP     LAC46                             ; JMP TO ERROR HANDLER
LAFDF
        LDA     INPFLG                            ; = GET THE INPUT FLAG AND BRANCH
        BEQ     LAFEA                             ; = IF 'INPUT'
        LDX     DATTXT                            ; * GET LINE NUMBER WHERE THE ERROR OCCURRED
        STX     CURLIN                            ; * AND USE IT AS THE CURRENT LINE NUMBER
        JMP     LB277                             ; 'SYNTAX ERROR'
LAFEA
        LDX     #LAFCF-1                          ; * POINT X TO '?REDO' AND PRINT
...
INPUT
        ...
        RTS
LB00F
        CMPA    #$22                              ; CHECK FOR PROMPT STRING DELIMITER
...
LB01E
        LDX     #LINBUF                           ; POINT TO BASIC'S LINE BUFFER
...
LB035
        JSR     LA390                             ; GO READ IN A BASIC LINE
...
LB03F
        LDB     #2*23                             ; 'INPUT PAST END OF FILE' ERROR
        RTS
;*
;* READ
READ
        LDX     DATPTR                            ; GET 'READ' START ADDRESS
        FCB     SKP1LD                            ; SKIP ONE BYTE - LDA #*$4F
LB049
        CLRA                                      ; 'INPUT' ENTRY POINT: INPUT FLAG = 0
        STA     INPFLG                            ; SET INPUT FLAG; 0 = INPUT: <> 0 = READ
        STX     DATTMP                            ; SAVE 'READ' START ADDRESS/'INPUT' BUFFER START
LB04E
        JSR     LB357                             ; EVALUATE A VARIABLE
...
;* READ/INPUT A STRING VARIABLE
        ...
        CMPA    #$22                              ; CHECK FOR STRING DELIMITER
        ...
        LDA     #','                              ; COMMA
LB08B
        STA     ENDCHR                            ; SAVE AS TERMINATOR 2
...
LB098
        JSR     LBD12                             ; CONVERT AN ASCII STRING TO FP NUMBER
...
LB0E8
        FCC     "?EXTRA IGNORED"                  ; ?EXTRA IGNORED MESSAGE
...
;* NEXT
NEXT
        BNE     LB0FE                             ; BRANCH IF ARGUMENT GIVEN
        LDX     ZERO                              ; X = 0: DEFAULT FOR NO ARGUMENT
        BRA     LB101
LB0FE
        JSR     LB357                             ; EVALUATE AN ALPHA EXPRESSION
LB101
        STX     VARDES                            ; SAVE VARIABLE DESCRIPTOR POINTER
        JSR     LABF9                             ; GO SCAN FOR 'FOR/NEXT' DATA ON STACK
        BEQ     LB10C                             ; BRANCH IF DATA FOUND
        LDB     #0                                ; 'NEXT WITHOUT FOR' ERROR (SHOULD BE CLRB)
LB10A
        BRA     LB153                             ; PROCESS ERROR
LB10C
        TFR     X,S                               ; POINT S TO START OF 'FOR/NEXT' DATA
...
LB131
        JMP     LAD9E                             ; JUMP BACK TO COMMAND INTEPR. LOOP
LB134
        LEAS    18,S                              ; PULL THE 'FOR-NEXT' DATA OFF THE STACK
        JSR     GETCCH                            ; GET CURRENT INPUT CHARACTER
...
LB141
        BSR     LB156                             ; EVALUATE EXPRESSION AND DO A TYPE CHECK FOR NUMERIC
LB143
...
LB148
        TST     VALTYP                            ; TEST TYPE FLAG; DO NOT CHANGE CARRY
        BCS     LB14F                             ; BRANCH IF STRING
        BPL     LB0E7                             ; RETURN ON PLUS
        FCB     SKP2                              ; SKIP 2 BYTES - 'TM' ERROR
LB14F
        BMI     LB0E7                             ; RETURN ON MINUS
        LDB     #12*2                             ; 'TYPE M1SMATCH' ERROR
LB153
        JMP     LAC46                             ; PROCESS ERROR
;* EVALUATE EXPRESSION
LB156
        BSR     LB1C6                             ; BACK UP INPUT POINTER
LB158
        CLRA                                      ; END OF OPERATION PRECEDENCE FLAG
        FCB     SKP2                              ; SKIP TWO BYTES
LB15A
        PSHS    B                                 ; SAVE FLAG (RELATIONAL OPERATOR FLAG)
...
;*
LB181
        LDB     TRELFL                            ; GET RELATIONAL OPERATOR FLAG
...
LB19F
        PULS    A                                 ; GET PRECEDENCE FLAG FROM STACK
...
LB1B8
        ASL     VALTYP                            ; BIT 7 OF TYPE FLAG TO CARRY
...
LB1C6
        LDX     CHARAD                            ; * GET BASIC'S INPUT POINTER AND
        JMP     LAEBB                             ; * MOVE IT BACK ONE
;* RELATIONAL COMPARISON JUMP TABLE
LB1CB
        FCB     $64                               ; RELATIONAL COMPARISON FLAG
LB1CC
        FDB     LB2F4                             ; JUMP ADDRESS

LB1CE
        CMPA    ,X                                ; COMPARE PRECEDENCE OF LAST DONE OPERATION TO
...
LB1D4
        LDD     1,X                               ; GET ADDRESS OF OPERATOR ROUTINE
...
LB1E2
        LDB     FP0SGN                            ; GET SIGN OF FPA0 MANTISSA
        LDA     ,X                                ; GET PRECEDENCE CODE TO ACCA
LB1E6
        PULS    Y                                 ; GET RETURN ADDRESS FROM STACK & PUT IT IN Y
        PSHS    B                                 ; SAVE ACCB ON STACK
LB1EA
        LDB     FP0EXP                            ; * PUSH FPA0 ONTO THE STACK
        LDX     FPA0                              ; *
        LDU     FPA0+2                            ; *
        PSHS    U,X,B                             ; *
...
LB1F4
        LDX     ZERO                              ; POINT X TO DUMMY VALUE (ZERO)
        LDA     ,S+                               ; GET PRECEDENCE FLAG FROM STACK
        BEQ     LB220                             ; BRANCH IF END OF EXPRESSION
LB1FA
        CMPA    #$64                              ; * CHECK FOR RELATIONAL COMPARISON FLAG
        BEQ     LB201                             ; * AND BRANCH IF RELATIONAL COMPARISON
        JSR     LB143                             ; 'TM' ERROR IF VARIABLE TYPE = STRING
LB201
        STX     RELPTR                            ; SAVE POINTER TO OPERATOR ROUTINE
LB203
        PULS    B                                 ; GET RELATIONAL OPERATOR FLAG FROM STACK
...
LB223
        JSR     XVEC15                            ; CALL EXTENDED BASIC ADD-IN
        CLR     VALTYP                            ; INITIALIZE TYPE FLAG TO NUMERIC
        JSR     GETNCH                            ; GET AN INPUT CHAR
        BCC     LB22F                             ; BRANCH IF NOT NUMERIC
LB22C
        JMP     LBD12                             ; CONVERT ASCII STRING TO FLOATING POINT -
...
LB22F
        ...
        CMPA    #$22                              ; STRING DELIMITER?
        BNE     LB24E                             ; NO
LB244
        LDX     CHARAD                            ; CURRENT BASIC POINTER TO X
        JSR     LB518                             ; SAVE STRING ON STRING STACK
LB249
        LDX     COEFPT                            ; * GET ADDRESS OF END OF STRING AND
        STX     CHARAD                            ; * PUT BASIC'S INPUT POINTER THERE
        RTS
LB24E
        CMPA    #TOK_NOT                          ; NOT TOKEN?
        BNE     LB25F                             ; NO
...
LB25F
        INCA                                      ; CHECK FOR TOKENS PRECEEDED BY $FF
...
LB290
        JSR     GETNCH                            ; GET AN INPUT CHARACTER (SECONDARY TOKEN)
        ...
        JMP     LB277                             ; SYNTAX ERROR
LB29F
        PSHS    B                                 ; SAVE TOKEN OFFSET ON STACK
...
LB2C7
        BSR     LB262                             ; SYNTAX CHECK FOR A '('
LB2C9
        PULS    B                                 ; GET TOKEN OFFSET
...
LB2D4
        FCB     SKP1LD                            ; SKIP ONE BYTE - 'OR' FLAG = $4F
...
LB2ED
        ORA     CHARAC                            ; * 'OR' ACCD WITH FPA0 INTEGER
        ORB     ENDCHR                            ; * STORED IN CHARAC
LB2F1
        JMP     GIVABF                            ; CONVERT THE VALUE IN ACCD INTO A FP NUMBER

;* RELATIONAL COMPARISON PROCESS HANDLER
LB2F4
        JSR     LB148                             ; 'TM' ERROR IF TYPE MISMATCH
...
LB328
        STA     FP0SGN                            ; SAVE TRUE/FALSE FLAG
...
LB33F
        ADDB    #1                                ; CONVERT $FF,0,1 TO 0,1,2
...
COMPARISON
        ...
        LDB     #$FF                              ; TRUE FLAG
LB348
        JMP     LBC7C                             ; CONVERT ACCB INTO FP NUMBER IN FPA0

;* DIM
LB34B
        JSR     LB26D                             ; SYNTAX CHECK FOR COMMA
DIM
        LDB     #1                                ; DIMENSION FLAG
...
LB357
        CLRB                                      ; DIMENSION FLAG = 0; DO NOT SET UP AN ARRAY
        JSR     GETCCH                            ; GET CURRENT INPUT CHARACTER
LB35A
        STB     DIMFLG                            ; SAVE ARRAY FLAG
;* ENTRY POINT FOR DEF FN VARIABLE SEARCH
LB35C
        STA     VARNAM                            ; SAVE INPUT CHARACTER
        JSR     GETCCH                            ; GET CURRENT INPUT CHARACTER
...
LB371
        TFR     A,B                               ; SAVE 2ND CHARACTER IN ACCB
...
LB395
        CMPX    ARYTAB                            ; COMPARE X TO THE END OF VARIABLES
...
LB3AB
        LDX     #ZERO                             ; POINT X TO ZERO LOCATION
...
;*         TOP  OF VARIABLES
        ...
        STA     4,X                               ; *
LB3DC
        STX     VARPTR                            ; STORE ADDRESS OF VARIABLE VALUE
LB3DE
        RTS
;*
LB3DF
        FCB     $90,$80,$00,$00,$00               ; * FLOATING POINT -32768
;*                             ; SMALLEST SIGNED TWO BYTE INTEGER
;*
LB3E4
        JSR     GETNCH                            ; GET AN INPUT CHARACTER FROM BASIC
LB3E6
        JSR     LB141                             ; GO EVALUATE NUMERIC EXPRESSION
LB3E9
...
INTCNV
        JSR     LB143                             ; 'TM' ERROR IF STRING VARIABLE
...
LB42A
        CMPX    ARYEND                            ; COMPARE TO END OF ARRAYS
...
LB43B
        LDB     #2*9                              ; 'REDIMENSIONED ARRAY' ERROR
...
LB44F
        LDD     #5                                ; * 5 BYTES/ARRAY ENTRY SAVE AT COEFPT
        STD     COEFPT                            ; *
...
LB461
        LDB     #11                               ; * DEFAULT DIMENSION VALUE:X(10)
        CLRA                                      ; *
...
LB46D
        STD     5,X                               ; SAVE LENGTH OF ARRAY DIMENSION
...
LB48C
        LEAX    -1,X                              ; * STORE TWO TERMINATOR BYTES AT
...
LB4A0
        LDB     4,X                               ; GET THE NUMBER OF DIMENSIONS
        STB     TMPLOC                            ; TEMPORARILY SAVE
        CLRA                                      ; * INITIALIZE POINTER
        CLRB                                      ; * TO ZERO
LB4A6
        STD     COEFPT                            ; SAVE ACCUMULATED POINTER
...
LB4B9
        LEAX    2,X                               ; MOVE POINTER TO NEXT DIMENSION
...
LB4CE
        LDA     #16                               ; 16 SHIFTS TO DO A MULTIPLY
...
LB4E6
        DEC     V45                               ; * DECREMENT SHIFT COUNTER
...
;*
MEM
        TFR     S,D                               ; PUT STACK POINTER INTO ACCD
...
LB50D
        STX     V4D                               ; SAVE X IN V4D
LB50F
        BSR     LB56D                             ; RESERVE ACCB BYTES IN STRING SPACE
LB511
        STX     STRDES+2                          ; SAVE NEW STRING ADDRESS
...
LB533
        CMPA    #$22                              ; = COMPARE CHARACTER TO STRING DELIMITER
        BEQ     LB539                             ; = & DON'T MOVE POINTER BACK IF SO
LB537
        LEAX    -1,X                              ; MOVE POINTER BACK ONE
LB539
        STX     COEFPT                            ; SAVE END OF STRING ADDRESS
...
LB54C
        LDX     TEMPPT                            ; GET NEXT AVAILABLE STRING STACK DESCRIPTOR
...
LB555
        JMP     LAC46                             ; JUMP TO ERROR SERVICING ROUTINE
LB558
        LDA     STRDES                            ; * GET LENGTH OF STRING AND SAVE IT
...
LB56D
        CLR     GARBFL                            ; CLEAR STRING REORGANIZATION FLAG
LB56F
        CLRA                                      ; * PUSH THE LENGTH OF THE
...
LB585
        LDB     #2*13                             ; OUT OF STRING SPACE' ERROR
...
LB591
        LDX     MEMSIZ                            ; GET THE TOP OF STRING SPACE
LB593
        STX     STRTAB                            ; SAVE TOP OF UNORGANIZED STRING SPACE
        CLRA                                      ; * ZERO OUT ACCD
...
LB5A0
        CMPX    TEMPPT                            ; COMPARE TO ADDRESS OF NEXT AVAILABLE DESCRIPTOR
        BEQ     LB5A8                             ; BRANCH IF TOP OF STRING STACK
        BSR     LB5D8                             ; CHECK FOR STRING IN UNORGANIZED STRING SPACE
        BRA     LB5A0                             ; KEEP CHECKING
LB5A8
        LDX     VARTAB                            ; GET THE END OF BASIC PROGRAM
LB5AA
        CMPX    ARYTAB                            ; COMPARE TO END OF VARIABLES
...
LB5B2
        STX     V41                               ; SAVE ADDRESS OF THE END OF VARIABLES
LB5B4
        LDX     V41                               ; GET CURRENT ARRAY POINTER
LB5B6
        CMPX    ARYEND                            ; COMPARE TO THE END OF ARRAYS
...
LB5D2
        LDA     1,X                               ; GET F1RST BYTE OF VARIABLE NAME
...
LB5EE
        RTS
LB5EF
        LDX     V4B                               ; GET ADDRESS OF THE DESCRIPTOR FOR THE
...
LB60F
        LDD     FPA0+2                            ; * GET DESCRIPTOR ADDRESS OF STRING A
        ...
        JMP     LAC46                             ; JUMP TO ERROR SERVICING ROUTINE
LB62A
        JSR     LB50D                             ; RESERVE ROOM IN STRING SPACE FOR NEW STRING
...
LB643
        LDX     2,X                               ; POINT X TO SOURCE ADDRESS
LB645
        LDU     FRESPC                            ; POINT U TO DESTINATION ADDRESS
        INCB                                      ; COMPENSATION FOR THE DECB BELOW
        BRA     LB64E                             ; GO MOVE THE BYTES
;* MOVE B BYTES FROM (X) TO (U)
LB64A
        LDA     ,X+                               ; * GET A SOURCE BYTE AND MOVE IT
...
LB657
        LDX     FPA0+2                            ; GET ADDRESS OF SELECTED STRING DESCRIPTOR
LB659
        LDB     ,X                                ; GET LENGTH OF STRING
...
LB66F
        LEAX    1,X                               ; ADD ONE TO POINTER
        RTS
LB672
        LDX     2,X                               ; *POINT X TO ADDRESS OF STRING NOT
...
LB675
        CMPX    LASTPT                            ; *COMPARE TO LAST USED DESCRIPTOR ADDRESS
...
;* LEN
LEN
        BSR     LB686                             ; POINT X TO PROPER STRING AND GET LENGTH
LB683
        JMP     LB4F3                             ; CONVERT ACCB TO FP NUMBER IN FPA0
;* POINT X TO STRING ADDRESS LOAD LENGTH INTO
;* ACCB. ENTER WITH THE STRING DESCRIPTOR IN
;* BOTTOM TWO BYTES OF FPA0
LB686
        BSR     LB654                             ; GET LENGTH AND ADDRESS OF STRING
        CLR     VALTYP                            ; SET VARIABLE TYPE TO NUMERIC
...
;* CHR$
CHR
        JSR     LB70E                             ; CONVERT FPA0 TO AN INTEGER IN ACCD
LB68F
        LDB     #1                                ; * RESERVE ONE BYTE IN
...
LB69B
        LEAS    2,S                               ; PURGE THE RETURN ADDRESS OFF OF THE STACK
LB69D
        JMP     LB54C                             ; PUT TEMP DESCRIPTOR DATA ONTO STRING STACK
;
;
ASC
        BSR     LB6A4                             ; PUT 1ST CHARACTER OF STRING INTO ACCB
        BRA     LB683                             ; CONVERT ACCB INTO FP NUMBER IN FPA0
LB6A4
        BSR     LB686                             ; POINT X TO STRING DESCRIPTOR
...
LEFT
        BSR     LB6F5                             ; GET ARGUMENTS FROM STACK
LB6AD
        CLRA                                      ; CLEAR STRING POINTER OFFSET - OFFSET = 0 FOR LEFT$
LB6AE
        CMPB    ,X                                ; * COMPARE LENGTH PARAMETER TO LENGTH OF
...
LB6B5
        PSHS    B,A                               ; PUSH PARAMETERS ONTO STACK
...
;* MID$
MID
        LDB     #$FF                              ; * GET DEFAULT VALUE OF LENGTH AND
...
LB706
        JMP     LB44A                             ; 'ILLEGAL FUNCTION CALL'
...
LB70E
        JSR     LB3E9                             ; CONVERT FPA0 TO INTEGER IN ACCD
...
;* VAL
VAL
        JSR     LB686                             ; POINT X TO STRING ADDRESS
...
LB734
        BSR     LB73D                             ; * EVALUATE AN EXPRESSION, RETURN
        STX     BINVAL                            ; * THE VALUE IN X; STORE IT IN BINVAL
LB738
        JSR     LB26D                             ; SYNTAX CHECK FOR A COMMA
...
;* PEEK
PEEK
        BSR     LB740                             ; CONVERT FPA0 TO INTEGER IN REGISTER X
        LDB     ,X                                ; GET THE VALUE BEING 'PEEK'ED
        JMP     LB4F3                             ; CONVERT ACCB INTO A FP NUMBER
;
;* POKE
POKE
        BSR     LB734                             ; EVALUATE 2 EXPRESSIONS
...
;* LIST
LIST
        PSHS    CC                                ; SAVE ZERO FLAG ON STACK
...
LB784
        LDU     #$FFFF                            ; * SET THE DEFAULT ENDING LINE NUMBER
        STU     BINVAL                            ; * TO $FFFF
LB789
        LEAS    2,S                               ; PURGE RETURN ADDRESS FROM THE STACK
        LDX     LSTTXT                            ; POINT X TO STARTING LINE ADDRESS
LB78D
        JSR     LB95C                             ; MOVE CURSOR TO START OF A NEW LINE
...
LB79F
        STX     LSTTXT                            ; SAVE NEW STARTING LINE ADDRESS
...
LB829
        CLR     V43                               ; CLEAR ILLEGAL TOKEN FLAG
        CLR     V44                               ; CLEAR DATA FLAG
LB82D
        LDA     ,X+                               ; GET INPUT CHAR
...
LB85A
        BRA     LB82D                             ; GO GET ANOTHER CHARACTER
LB85C
        CLR     ,U+                               ; * DOUBLE ZERO AT END OF LINE
        CLR     ,U+                               ; *
...
;*                             ; TABLE FOR BASIC - 10
LB89B
        CLR     V42                               ; INITIALIZE V42 AS TOKEN COUNTER
LB89D
        LEAU    10,U                              ; MOVE TO NEXT COMMAND INTERPRETATION TABLE
...
LB8A6
        LDX     ,S                                ; GET POINTER TO INPUT STRING
LB8A8
        LDB     ,Y+                               ; GET A BYTE FROM DICTIONARY TABLE
...
LB8C2
        STD     ,U++                              ; SECONDARY TOKENS PRECEEDED BY $FF
        BRA     LB85A                             ; GO PROCESS MORE INPUT CHARACTERS
LB8C6
        STB     ,U+                               ; SAVE THIS TOKEN
        CMPB    #TOK_DATA                         ; DATA TOKEN?
        BNE     LB8CE                             ; NO
        INC     V44                               ; SET DATA FLAG
LB8CE
        CMPB    #TOK_REM                          ; REM TOKEN?
        BEQ     LB87C                             ; YES
LB8D2
        BRA     LB85A                             ; GO PROCESS MORE INPUT CHARACTERS
;* CHECK FOR A SECONDARY TOKEN
LB8D4
        LDU     #COMVEC-5                         ; NOW DO SECONDARY FUNCTIONS
...
LB8EA
        INC     V42                               ; INCREMENT TOKEN COUNTER
...
LB8FE
LB918
        JSR     XVEC9                             ; CALL EXTENDED BASIC ADD-IN
LB91B
        BEQ     LB965                             ; RETURN IF END OF LINE
LB91D
        CMPA    #TOK_TAB                          ; TOKEN FOR TAB( ?
        BEQ     LB97E                             ; YES
        CMPA    #','                              ; COMMA?
...
LB938
        BSR     LB99F                             ; PRINT STRING POINTED TO BY X
        PULS    B                                 ; GET VARIABLE TYPE BACK
        JSR     LA35F                             ; SET UP TAB WIDTH ZONE, ETC
LB949
        TSTB                                      ; CHECK CURRENT PRINT POSITION
...
LB975
        LDB     DEVPOS                            ; *
LB977
        SUBB    DEVCFW                            ; * SUBTRACT TAB FIELD WIDTH FROM CURRENT
...
;* PRINT TAB(
LB97E
        JSR     LB709                             ; EVALUATE EXPRESSION - RETURN VALUE IN B
...
LB99C
        JSR     LB518                             ; PARSE A STRING FROM X AND PUT
;*         DESCRIPTOR ON STRING STACK
LB99F
        JSR     LB657                             ; GET LENGTH OF STRING AND REMOVE
...
LB9E2
        CMPB    #-8                               ; TEST DIFFERENCE OF EXPONENTS
...
LBA18
        BCS     LBA1C                             ; BRANCH IF POSITIVE MANTISSA
        BSR     LBA79                             ; NEGATE FPA0 MANTISSA
;
;* NORMALIZE FPA0
LBA1C
        CLRB                                      ; CLEAR TEMPORARY EXPONENT ACCUMULATOR
LBA1D
        LDA     FPA0                              ; TEST MSB OF MANTISSA
...
LBA39
        CLRA                                      ; A ZERO EXPONENT = 0 FLOATING POINT
LBA3A
        STA     FP0EXP                            ; ZERO OUT THE EXPONENT
        STA     FP0SGN                            ; ZERO OUT THE MANTISSA SIGN
LBA3E
        RTS
LBA3F
        BSR     LBAAE                             ; SHIFT FPA0 MANTISSA TO RIGHT
        CLRB                                      ; CLEAR CARRY FLAG
        BRA     LB9EC
;* SHIFT FPA0 LEFT ONE BIT UNTIL BIT 7
;* OF MATISSA MS BYTE = 1
LBA44
        INCB                                      ; ADD ONE TO EXPONENT ACCUMULATOR
...
LBA4F
        BPL     LBA44                             ; BRANCH IF NOT YET NORMALIZED
...
;*         SIZE OF THE EXPONENT
        FCB     SKP2                              ; SKIP 2 BYTES
LBA5C
        BCS     LBA66                             ; BRANCH IF MANTISSA OVERFLOW
...
LBA66
        INC     FP0EXP                            ; INCREMENT EXPONENT - MULTIPLY BY 2
...
LBA72
        BCC     LBA78                             ; BRANCH IF NO ROUND-OFF NEEDED
...
LBA79
        COM     FP0SGN                            ; TOGGLE SIGN OF MANTISSA
LBA7B
        COM     FPA0                              ; * COMPLEMENT ALL 4 MANTISSA BYTES
        COM     FPA0+1                            ; *
        COM     FPA0+2                            ; *
        COM     FPA0+3                            ; *
;* ADD ONE TO FPA0 MANTISSA
LBA83
        LDX     FPA0+2                            ; * GET BOTTOM 2 MANTISSA
...
LBA91
        RTS
LBA92
        LDB     #2*5                              ; OV' OVERFLOW ERROR
        JMP     LAC46                             ; PROCESS AN ERROR
LBA97
        LDX     #FPA2-1                           ; POINT X TO FPA2
...
LBA9A
        LDA     4,X                               ; GET LS BYTE OF MANTISSA (X)
...
LBAAE
        ADDB    #8                                ; ADD 8 TO DIFFERENCE OF EXPONENTS
...
;
LBAB8
        ASR     1,X                               ; * SHIFT MANTISSA AND SUB BYTE ONE BIT TO THE RIGHT
LBABA
        ROR     2,X                               ; *
        ROR     3,X                               ; *
        ROR     4,X                               ; *
...
LBAC4
        RTS
LBAC5
        FCB     $81,$00,$00,$00,$00               ; FLOATING POINT CONSTANT 1.0
;
;* ARITHMETIC OPERATION (*) JUMPS HERE - MULTIPLY
;* FPA0 BY (X) - RETURN PRODUCT IN FPA0
LBACA
        BSR     LBB2F                             ; MOVE PACKED FPA FROM (X) TO FPA1
LBACC
...
LBAD0
        LDA     #0                                ; * ZERO OUT MANTISSA OF FPA2
        STA     FPA2                              ; *
        STA     FPA2+1                            ; *
        STA     FPA2+2                            ; *
        STA     FPA2+3                            ; *
...
LBB00
        BEQ     LBA97                             ; SHIFT FPA2 ONE BYTE TO RIGHT
LBB02
        COMA                                      ; SET CARRY FLAG
;* MULTIPLY FPA1 MANTISSA BY ACCB AND
;* ADD PRODUCT TO FPA2 MANTISSA
LBB03
        LDA     FPA2                              ; GET FPA2 MS BYTE
...
;*         DATA BIT INTO CARRY
        ...
        ADCA    FPA1                              ; =
LBB20
        RORA                                      ; * ROTATE CARRY INTO MS BYTE
        STA     FPA2                              ; *
...
LBB2F
        LDD     1,X                               ; GET TWO MSB BYTES OF MANTISSA FROM
;*         FPA  POINTED TO BY X
...
LBB63
        LBPL    LBA39                             ; ZERO FPA0 MANTISSA SIGN & EXPONENT
LBB67
        JMP     LBA92                             ; 'OV' OVERFLOW ERROR
;* FAST MULTIPLY BY 10 AND LEAVE RESULT IN FPA0
LBB6A
        JSR     LBC5F                             ; TRANSFER FPA0 TO FPA1
...
LBB7C
        RTS
LBB7D
        FCB     $84,$20,$00,$00,$00               ; FLOATING POINT CONSTANT 10
;* DIVIDE FPA0 BY 10
LBB82
...
LBB8F
        BSR     LBB2F                             ; GET FP NUMBER FROM (X) TO FPA1
;
...
LBBA4
        LDA     FPA0                              ; * COMPARE THE TWO MS BYTES
...
LBBBD
        TFR     CC,A                              ; SAVE CARRY FLAG STATUS IN ACCA; CARRY
;*         CLEAR IF FPA0 > FPA1
...
LBBCC
        TFR     A,CC                              ; RESTORE CARRY FLAG AND
        BCS     LBBDE                             ; BRANCH IF FPA0 =< FPA1
LBBD0
        ASL     FPA1+3                            ; * SHIFT FPA1 MANTISSA 1 BIT TO LEFT
        ROL     FPA1+2                            ; *
        ROL     FPA1+1                            ; *
        ROL     FPA1                              ; *
...
LBBDE
        LDA     FPA1+3                            ; * SUBTRACT THE LS BYTES OF MANTISSA
        SUBA    FPA0+3                            ; *
        STA     FPA1+3                            ; *
...
LBBF8
        LDB     #$40                              ; USE ONLY TWO BITS OF THE LAST BYTE (FIFTH)
        BRA     LBBCC                             ; GO SHIFT THE LAST BYTE
LBBFC
        RORB                                      ; * SHIFT CARRY (ALWAYS SET HERE) INTO
        RORB                                      ; * BIT 5 AND MOVE
...
;
LBC2A
        LDX     #V45                              ; POINT X TO MANTISSA OF FPA4
        BRA     LBC35                             ; MOVE FPA0 TO FPA4
LBC2F
        LDX     #V40                              ; POINT X TO MANTISSA OF FPA3
        FCB     SKP2                              ; SKIP TWO BYTES
LBC33
        LDX     VARDES                            ; POINT X TO VARIABLE DESCRIPTOR IN VARDES
...
LBC4A
        LDA     FP1SGN                            ; * COPY MANTISSA SIGN FROM
LBC4C
        STA     FP0SGN                            ; * FPA1 TO FPA0
...
LBC5F
        LDD     FP0EXP                            ; * TRANSFER EXPONENT & MS BYTE
        STD     FP1EXP                            ; *
...
LBC71
        LDB     FP0SGN                            ; GET SIGN OF MANTISSA
LBC73
        ROLB                                      ; BIT 7 TO CARRY
...
;* ABS
ABS
        CLR     FP0SGN                            ; FORCE MANTISSA SIGN OF FPA0 POSITIVE
        RTS
...
LBCC3
        RORB                                      ; SHIFT CARRY TO BIT 7; CARRY SET IF FPA0 < (X)
...
LBD09
        STB     FPA0                              ; * LOAD MANTISSA OF FPA0 WITH CONTENTS OF ACCB
        STB     FPA0+1                            ; *
        STB     FPA0+2                            ; *
        STB     FPA0+3                            ; *
LBD11
...
LBD86
        LDB     V45                               ; *GET THE RIGHT DECIMAL COUNTER AND SUBTRACT
...
LBD99
        JSR     LBC2F                             ; PACK FPA0 AND SAVE IT IN FPA3
...
;*
LBDB6
        FCB     $9B,$3E,$BC,$1F,$FD               ; * 99999999.9
LBDBB
        FCB     $9E,$6E,$6B,$27,$FD               ; * 999999999
LBDC0
        FCB     $9E,$6E,$6B,$28,$00               ; * 1E + 09
;*
LBDC5
        LDX     #LABE8-1                          ; POINT X TO " IN " MESSAGE
...
LBDCC
        STD     FPA0                              ; SAVE ACCD IN TOP HALF OF FPA0
...
LBDD6
        JMP     LB99C                             ; COPY A STRING FROM (X) TO CONSOLE OUT
;
;* CONVERT FP NUMBER TO ASCII STRING
LBDD9
        LDU     #STRBUF+3                         ; POINT U TO BUFFER WHICH WILL NOT CAUSE
;*                             ; THE STRING TO BE STORED IN STRING SPACE
LBDDC
        LDA     #SPACE                            ; SPACE = DEFAULT SIGN FOR POSITIVE #
        LDB     FP0SGN                            ; GET SIGN OF FPA0
        BPL     LBDE4                             ; BRANCH IF POSITIVE
        LDA     #'-'                              ; ASCII MINUS SIGN
LBDE4
        STA     ,U+                               ; STORE SIGN OF NUMBER
...
;* SCIENTIFIC NOTATION
LBE01
        LDX     #LBDBB                            ; POINT X TO FP 999,999,999
        JSR     LBCA0                             ; COMPARE FPA0 TO 999,999,999
        BGT     LBE18                             ; BRANCH IF > 999,999,999
LBE09
        LDX     #LBDB6                            ; POINT X TO FP 99,999,999.9
...
LBE36
        DECA                                      ; * SUBTRACT TWO (WITHOUT AFFECTING CARRY)
...
LBE4B
        LDX     #LBEC5                            ; POINT X TO FP POWER OF 10 MANTISSA
...
LBE72
        ...
        STA     ,U+                               ; * STRING BUFFER
LBE84
        COMB                                      ; TOGGLE BIT 7 (ADD/SUBTRACT FLAG)
...
LBE8C
        LDA     ,-U                               ; GET THE LAST CHARACTER; MOVE POINTER BACK
...
LBEA3
        STA     2,U                               ; STORE EXPONENT SIGN IN STRING
...
;
LBEAB
        INCA                                      ; ADD ONE TO 10'S DIGIT OF EXPONENT
...
LBEB8
        STA     ,U                                ; STORE LAST CHARACTER
LBEBA
        CLR     1,U                               ; CLEAR LAST BYTE (TERMINATOR - REQUIRED BY
;*         PRINT SUBROUTINES)
LBEBC
        LDX     #STRBUF+3                         ; RESET POINTER TO START OF BUFFER
        RTS
;*
LBEC0
        FCB     $80,$00,$00,$00,$00               ; FLOATING POINT .5
;*
...
LBF3B
        LDX     RVSEED+1                          ; * MOVE VARIABLE
        STX     FPA0                              ; * RANDOM NUMBER
        LDX     RVSEED+3                          ; * SEED TO
        STX     FPA0+2                            ; * FPA0
LBF45
        LDX     RSEED                             ; = MOVE FIXED
...
;*
RSEED
        FDB     $40E6                             ; *CONSTANT RANDOM NUMBER GENERATOR SEED
        FDB     $4DAB                             ; *
;
;* SIN
...
LBFA6
        JSR     LBEE9                             ; TOGGLE MANTISSA SIGN OF FPA0
LBFA9
        LDX     #LBFC2                            ; POINT X TO FP (.25)
...
LBFBD
        FCB     $83,$49,$0F,$DA,$A2               ; 6.28318531 (2*PI)
LBFC2
        FCB     $7F,$00,$00,$00,$00               ; .25
;
;
LBFC7
        FCB     6-1                               ; SIX COEFFICIENTS
LBFC8
...
COS
        LDX     #L83AB                            ; POINT X TO FP CONSTANT (P1/2)
        JSR     LB9C2                             ; ADD FPA0 TO (X)
L837E
        JMP     SIN                               ; JUMP TO SIN ROUTINE
;
;* TAN
;* THE VALUE OF TAN(X) IS DETERMINED BY THE TRIG IDENTITY TAN(X)=SIN(X)/COS(X)
TAN
        JSR     LBC2F                             ; PACK FPA0 AND MOVE IT TO FPA3
        ...
        LDX     #V4A                              ; POINT X TO FPA5
L83A3
        JMP     LBB8F                             ; DIVIDE (X) BY FPA0 - SIN(X)/COS(X)
L83A6
        PSHS    A                                 ; SAVE SIGN FLAG ON STACK
        JMP     LBFA6                             ; EXPAND POLYNOMIAL
;
L83AB
        FCB     $81,$49,$0F,$DA,$A2               ; 1.57079633 (PI/2)
;
;* ATN
...
;
ATN
        LDA     FP0SGN                            ; * GET THE SIGN OF THE MANTISSA AND
        PSHS    A                                 ; * SAVE IT ON THE STACK
...
L83C5
        LDX     #L83E0                            ; POINT (X) TO TAYLOR SERIES COEFFICIENTS
...
L83D7
        PULS    A                                 ; * GET SIGN OF INITIAL ARGUMENT MANTISSA
        TSTA                                      ; * AND SET FLAGS ACCORDING TO IT
        BPL     L83DF                             ; RETURN IF ARGUMENT WAS POSITIVE
L83DC
        JMP     LBEE9                             ; CHANGE MANTISSA SIGN OF FPA0
L83DF
        RTS
;*
...
L83EB
        FCB     $7B,$83,$FC,$B0,$10               ; -0.0161117018
L83F0
        FCB     $7C,$0C,$1F,$67,$CA               ; 0.0342096381
L83F5
        FCB     $7C,$DE,$53,$CB,$C1               ; -0.0542791328
L83FA
        FCB     $7D,$14,$64,$70,$4C               ; 0.0724571965
L83FF
        FCB     $7D,$B7,$EA,$51,$7A               ; -0.0898023954
L8404
        FCB     $7D,$63,$30,$88,$7E               ; 0.110932413
L8409
        FCB     $7E,$92,$44,$99,$3A               ; -0.142839808
L840E
        FCB     $7E,$4C,$CC,$91,$C7               ; 0.199999121
L8413
        FCB     $7F,$AA,$AA,$AA,$13               ; -0.333333316
L8418
...
;*
L841D
        FCB     3                                 ; FOUR COEFFICIENTS
L841E
        FCB     $7F,$5E,$56,$CB,$79               ; 0.434255942
L8423
        FCB     $80,$13,$9B,$0B,$64               ; 0.576584541
L8428
        FCB     $80,$76,$38,$93,$16               ; 0.961800759
L842D
        FCB     $82,$38,$AA,$3B,$20               ; 2.88539007
;
L8432
        FCB     $80,$35,$04,$F3,$34               ; 1/SQR(2)
;
L8437
        FCB     $81,$35,$04,$F3,$34               ; SQR(2)
;
L843C
        FCB     $80,$80,$00,$00,$00               ; -0.5
;
L8441
        FCB     $80,$31,$72,$17,$F8               ; LN(2)
;*
...
L84AC
        JSR     LBC4C                             ; COPY FPA1 TO FPA0; ACCA = MANTISSA SIGN
...
L84C4
        FCB     $81,$38,$AA,$3B,$29               ; 1.44269504 ( CF )
;*
;* TCHEBYSHEV MODIFIED TAYLOR SERIES COEFFICIENTS FOR E**X
;*
L84C9
        FCB     7                                 ; EIGHT COEFFICIENTS
L84CA
...
L84DE
        FCB     $7C,$63,$59,$58,$0A               ; 0.0555051269
L84E3
        FCB     $7E,$75,$FD,$E7,$C6               ; 0.240226385
L84E8
        FCB     $80,$31,$72,$18,$10               ; 0.693147186
L84ED
        FCB     $81,$00,$00,$00,$00               ; 1
;*
;* EXP ( E**X)
...
;
EXP
        LDX     #L84C4                            ; POINT X TO THE CORRECTION FACTOR
        JSR     LBACA                             ; MULTIPLY FPA0 BY (X)
...
L8501
        JMP     LBB5C                             ; SET FPA0 = 0 OR 'OV' ERROR
L8504
...
L8529
        JMP     INT                               ; CONVERT FPA0 TO INTEGER
L852C
        COM     FP0SGN                            ; TOGGLE SIGN OF FPA0 MANTISSA
        BSR     L8529                             ; CONVERT FPA0 TO INTEGER
        JMP     LBEE9                             ; TOGGLE SIGN OF FPA0
;
;* EDIT
EDIT
        JSR     L89AE                             ; GET LINE NUMBER FROM BASIC
...
L854D
        LDD     BINVAL                            ; GET THE HEX VALUE OF LINE NUMBER
...
L855C
        CLRB                                      ; RESET DIGIT ACCUMULATOR - DEFAULT VALUE
L855D
        JSR     L8687                             ; GET KEY STROKE
...
L8570
        SUBB    #$01                              ; * REPEAT PARAMETER IN ACCB; IF IT
...
L85AB
        BSR     L85AF                             ; INTERPRET THE REMAINING COMMANDS AS SUBROUTINES
        BRA     L855C                             ; GO INTERPRET ANOTHER EDIT COMMAND
L85AF
        CMPA    #SPACE                            ; SPACE BAR?
        BNE     L85C3                             ; NO
L85B3
        FCB     SKP2                              ; SKIP TWO BYTES
...
;*
L85B4
        LDB     #LBUFMX-1                         ; 250 BYTES MAX IN BUFFER
L85B6
        LDA     ,X                                ; GET A CHARACTER FROM BUFFER
...
L85D1
        DEC     VD7                               ; DECREMENT LENGTH OF BUFFER
        LEAY    -1,X                              ; POINT Y TO ONE BEFORE CURRENT BUFFER POINTER
L85D5
        LEAY    $01,Y                             ; INCREMENT TEMPORARY BUFFER POINTER
...
L85F3
        BSR     L85B4                             ; DISPLAY THE LINE ON THE SCREEN
L85F5
...
L862E
        PSHS    X                                 ; SAVE CURRENT BUFFER POINTER
L8630
        TST     ,X+                               ; * SCAN THE LINE UNTIL END OF
        BNE     L8630                             ; * LINE (0) IS FOUND
L8634
        LDB     ,-X                               ; DECR TEMP LINE POINTER AND GET A CHARACTER
...
L8646
        ...
        BNE     L865C                             ; NO
L864A
        BSR     L8650                             ; MOVE POINTER BACK 1, SEND BS TO SCREEN
        DECB                                      ; DECREMENT REPEAT PARAMETER
...
L8650
        ...
        LDA     #BS                               ; BACK SPACE
L8659
        JMP     PUTCHR                            ; SEND TO CONSOLE OUT
L865C
        CMPA    #'K'                              ; KILL?
        BEQ     L8665                             ; YES
        SUBA    #'S'                              ; SEARCH?
        ...
        RTS
L8665
        PSHS    A                                 ; SAVE KILL/SEARCH FLAG ON STACK
        BSR     L8687                             ; * GET A KEYSTROKE (TARGET CHARACTER)
        PSHS    A                                 ; * AND SAVE IT ON STACK
L866B
        LDA     ,X                                ; GET CURRENT BUFFER CHARACTER
...
L8679
        JSR     L85D1                             ; REMOVE ONE CHARACTER FROM BUFFER
L867C
...
L8685
        PULS    Y,PC                              ; THE Y PULL WILL CLEAN UP THE STACK FOR THE 2 PSHS A
;*
;* GET A KEYSTRKE
L8687
        JSR     LA171                             ; CALL CONSOLE IN : DEV NBR=SCREEN
...
;* TRON
TRON
        FCB     SKP1LD                            ; SKIP ONE BYTE AND LDA #$4F
;
;* TROFF
TROFF
        CLRA                                      ; TROFF FLAG
...
;
POS
        LDA     #0                                ; GET DEVICE NUMBER
        LDB     LPTPOS                            ; GET PRINT POSITION
LA5E8
        SEX                                       ; CONVERT ACCB TO 2 DIGIT SIGNED INTEGER
...
L86FD
        ...
        JSR     LB738                             ; SYNTAX CHECK FOR COMMA AND EVALUATE LENGTH EXPRESSION
L870E
        PSHS    B                                 ; SAVE LENGTH PARAMETER ON STACK
        JSR     LB267                             ; SYNTAX CHECK FOR ')'
        LDB     #TOK_EQUALS                       ; TOKEN FOR =
...
L8724
        JMP     LB44A                             ; 'FC' ERROR IF POSITION > LENGTH OF OLDSTRING
L8727
        INCA                                      ; * NOW ACCA = NUMBER OF CHARACTERS TO THE RIGHT
...
L872E
        LDA     $01,S                             ; GET POSITION PARAMETER
...
L873F
        TFR     A,B                               ; SAVE NUMBER OF BYTES TO MOVE IN ACCB
...
L8768
        JSR     LB6A4                             ; GET FIRST BYTE OF STRING
L876B
        PSHS    B                                 ; SAVE FIRST BYTE OF EXPRESSION
...
L8776
        STA     ,X+                               ; SAVE A CHARACTER IN STRING SPACE
        DECB                                      ; DECREMENT LENGTH
        BNE     L8776                             ; BRANCH IF NOT DONE
L877B
        JMP     LB69B                             ; PUT STRING DESCRIPTOR ONTO STRING STACK
;
;* INSTR
INSTR
        JSR     LB26A                             ; SYNTAX CHECK FOR '('
...
L879C
        LDX     FPA0+2                            ; SEARCH STRING DESCRIPTOR ADDRESS
...
L87BE
        LEAY    ,X                                ; POINT Y TO SEARCH POSITION
...
L87CD
        LDA     ,X+                               ; GET A CHARACTER FROM SEARCH STRING
...
L880A
        JSR     GETNCH                            ; GET A CHARACTER FROM BASIC
L880C
        BLO     L8800                             ; BRANCH IF NUMERIC
L880E
        CLR     FPA0                              ; * CLEAR 2 HIGH ORDER
...
L882E
        LDB     #$04                              ; BASE 16 DIGIT MULTIPLIER = 2**4
        BSR     L8834                             ; ADD DIGIT TO TEMPORARY ACCUMULATOR
        BRA     L881F                             ; KEEP EVALUATING VARIABLE
L8834
        ASL     $01,X                             ; * MULTIPLY TEMPORARY
...
XVEC15
        PULS    U                                 ; PULL RETURN ADDRESS AND SAVE IN U REGISTER
        CLR     VALTYP                            ; SET VARIABLE TYPE TO NUMERIC
...
DEF
        LDX     [CHARAD]                          ; GET TWO INPUT CHARS
...
L88B1
        JMP     LB143                             ; 'TM' ERROR IF STRING VARIABLE
;* EVALUATE AN FN CALL
L88B4
        BSR     L88A1                             ; * GET THE DESCRIPTOR OF THE FN NAME
...
;* DEF USR
L890F
        JSR     GETNCH                            ; SKIP PAST SECOND BYTE OF DEF USR TOKEN
...
L891C
        ...
        JSR     GETNCH                            ; GET A CHARACTER FROM BASIC
L8927
        LDX     USRADR                            ; GET ADDRESS OF STORAGE LOCs FOR USR ADDRESS
        ASLB                                      ; X2 - 2 BYTES/USR ADDRESS
        ABX                                       ; ADD OFFSET TO START ADDRESS OF STORAGE LOCs
        RTS
;* PROCESS A USR CALL
L892C
        BSR     L891C                             ; GET STORAGE LOC OF EXEC ADDRESS FOR USR N
        ...
        LDA     VALTYP                            ; GET VARIABLE TYPE
L8943
        RTS                                       ; JUMP TO USR ROUTINE (PSHS X ABOVE)
L8944
        LDB     #TOK_EQUALS                       ; TOKEN FOR '='
        JSR     LB26F                             ; DO A SYNTAX CHECK FOR =
...
;* DEL
DEL
        LBEQ    LB44A                             ; 'FC' ERROR IF NO ARGUMENT
...
L898C
        LDA     #$FF                              ; = USE $FFXX AS DEFAULT ENDING
        STA     BINVAL                            ; = LINE NUMBER - SAVE IT IN BINVAL
L8990
        LDU     VD3                               ; POINT U TO STARTING LINE NUMBER ADDRESS
L8992
        FCB     SKP2                              ; SKIP TWO BYTES
L8993
        LDU     ,U                                ; POINT U TO START OF NEXT LINE
...
L899F
        LDX     VD3                               ; GET STARTING LINE NUMBER
...
L89AE
        JSR     LAF67                             ; GO GET LINE NUMBER CONVERTED TO BINARY
        JMP     LA5C7                             ; MAKE SURE THERE'S NO MORE ON THIS LINE
L89B4
        LDA     ,U+                               ; GET A BYTE FROM (U)
        STA     ,X+                               ; MOVE THE BYTE TO (X)
L89B8
        CMPU    VARTAB                            ; COMPARE TO END OF BASIC
...
;
L89C0
        JSR     L8866                             ; 'BS' ERROR IF IN DIRECT MODE
        JSR     GETNCH                            ; GET A CHAR FROM BASIC
L89D2
        CMPA    #$22                              ; CHECK FOR PROMPT STRING
...
L89E1
        LEAS    -2,S                              ; RESERVE TWO STORAGE SLOTS ON STACK
...
L89FC
        JSR     LAF67                             ; STRIP A DECIMAL NUMBER FROM BASIC INPUT LINE
        LDX     BINVAL                            ; GET BINARY VALUE
        RTS
L8A02
        LDX     VD1                               ; GET CURRENT OLD NUMBER BEING RENUMBERED
L8A04
        STX     BINVAL                            ; SAVE THE LINE NUMBER BEING SEARCHED FOR
...
RENUM
        ...
        JSR     GETCCH                            ; GET CURRENT INPUT CHARACTER
L8A20
        BEQ     L8A3D                             ; BRANCH IF END OF LINE
        JSR     LB26D                             ; SYNTAX CHECK FOR COMMA
...
L8A2D
        ...
        BEQ     L8A83                             ; 'FC' ERROR
L8A3A
        JSR     LA5C7                             ; CHECK FOR MORE CHARACTERS ON LINE - 'SYNTAX' ERROR IF ANY
L8A3D
        BSR     L8A02                             ; GO GET ADDRESS OF OLD NUMBER BEING RENUMBERED
...
L8A67
        FCB     SKP1LD                            ; SKIP ONE BYTE - LDA #$4F
L8A68
        CLRA                                      ; NEW LINE NUMBER FLAG - 0; INSERT NEW LINE NUMBERS
...
L8A83
        JMP     LB44A                             ; 'FC' ERROR IF LINE NUMBER MS BYTE > $F9
...
L8A90
        RTS
L8A91
        LDX     TXTTAB                            ; GET START OF BASIC PROGRAM
        LEAX    -1,X                              ; MOVE POINTER BACK ONE
L8A95
        LEAX    $01,X                             ; MOVE POINTER UP ONE
        BSR     L8A86                             ; RETURN IF END OF PROGRAM
L8A99
        LEAX    $03,X                             ; SKIP OVER NEXT LINE ADDRESS AND LINE NUMBER
L8A9B
        LEAX    $01,X                             ; MOVE POINTER TO NEXT CHARACTER
...
;*              ; * EXISTENCE OF LINE NUMBER, SET IT = 1 IF INSERTING LINE NUMBERS
        ...
        BRA     L8A99                             ; GO GET ANOTHER CHARACTER
L8AD3
        CLR     ,X                                ; CLEAR CARRY FLAG AND 1ST BYTE
...
L8ADD
        LDX     TXTTAB                            ; GET BEGINNING OF BASIC PROGRAM
        BRA     L8AE5
L8AE1
...
L8AE9
        LEAX    $01,X                             ; ADVANCE POINTER BY ONE
L8AEB
        STX     CHARAD                            ; SAVE NEW BASIC INPUT POINTER
L8AED
        JSR     GETNCH                            ; GET NEXT CHARACTER FROM BASIC
L8AEF
...
L8B17
        JSR     GETCCH                            ; GET CURRENT BASIC INPUT CHARRACTER
        BRA     L8AEF                             ; KEEP CHECKING THE LINE
L8B1B
        LDX     CHARAD                            ; GET CURRENT INPUT ADDRESS
        PSHS    X                                 ; SAVE IT ON THE STACK
        JSR     LAF67                             ; CONVERT DECIMAL BASIC NUMBER TO BINARY
        LDX     CHARAD                            ; GET CURRENT INPUT POINTER
L8B24
        LDA     ,-X                               ; GET PREVIOUS INPUT CHARACTER
...
L8B41
        STX     V47                               ; SAVE END OF NUMERIC VALUE
...
L8B55
        PULS    X                                 ; RESTORE POINTER TO START OF NUMERIC VALUE
...
L8B67
        STB     $01,X                             ; SAVE MS BYTE OF BINARY LINE NUMBER
...
L8BBE
        LEAX    $01,X                             ; MOVE POINTER FORWARD ONE
...
L8BC9
        LEAX    ,U                                ; TRANSFER NEW LINE POINTER TO (X)
...
;
L8BD9
        FCC     "UL "                             ; UNKNOWN LINE NUMBER MESSAGE
        FCB     0
;
;
HEXDOL
        JSR     LB740                             ; CONVERT FPA0 INTO A POSITIVE 2 BYTE INTEGER
        LDX     #STRBUF+2                         ; POINT TO TEMPORARY BUFFER
        LDB     #$04                              ; CONVERT 4 NIBBLES
L8BE5
        PSHS    B                                 ; SAVE NIBBLE COUNTER
        CLRB                                      ; CLEAR CARRY FLAG
        LDA     #$04                              ; 4 SHIFTS
L8BEA
        ASL     FPA0+3                            ; * SHIFT BOTTOM TWO BYTES OF
...
L8E69
        STB     VD3                               ; * SAVE THE CURRENT FORMAT STRING
...
L8E82
        LDX     TEMPTR                            ; * RESTORE CURRENT FORMAT STRING COUNTER
...
L8EA8
        LDA     VD7                               ; *CHECK NEXT PRINT ITEM FLAG AND
        BEQ     L8EB4                             ; *'FC' ERROR IF NO FURTHER PRINT ITEMS
        LDX     VD5                               ; RESET FORMAT STRING POINTER TO START OF STRING
L8EAE
        CLR     VD7                               ; RESET NEXT PRINT ITEM FLAG
        LDB     ,X                                ; GET LENGTH OF FORMAT STRING
        BNE     L8EB7                             ; INTERPRET FORMAT STRING IF LENGTH > 0
L8EB4
        JMP     LB44A                             ; 'FC' ERROR IF FORMAT STRING = NULL
L8EB7
        LDX     $02,X                             ; POINT X TO START OF FORMAT STRING
;* INTERPRET THE FORMAT STRING
L8EB9
        CLR     VDA                               ; CLEAR THE STATUS BYTE
L8EBB
        CLR     VD9                               ; CLEAR LEFT DIGIT COUNTER
        LDA     ,X+                               ; GET A CHARACTER FROM FORMAT STRING
...
L8EFB
        BNE     L8E88                             ; NO MATCH - ILLEGAL CHARACTER
...
L8F1A
        LDA     VDA                               ; * GET THE STATUS BYTE AND SET
...
L8F24
        CLR     VD8                               ; CLEAR THE RIGHT DIGIT COUNTER
L8F26
        INC     VD9                               ; ADD ONE TO LEFT DIGIT COUNTER
        DECB                                      ; DECREMENT FORMAT STRING LENGTH COUNTER
...
L8F4F
        INC     VD8                               ; ADD ONE TO RIGHT DIGIT COUNTER
...
L8F8F
        ORA     #$04                              ; 'OR' IN POST-SIGN FORCE FLAG
...
L8F96
        JSR     GETCCH                            ; GET CURRENT CHARACTER
...
L8FC4
        JSR     GETNCH                            ; GET NEXT INPUT CHARACTER
L8FC6
        LDX     VD5                               ; GET FORMAT STRING DESCRIPTOR ADDRESS
        LDB     ,X                                ; GET LENGTH OF FORMAT STRING
...
L9011
        LDA     ,X+                               ; * ADVANCE POINTER TO END OF
...
L902C
        LDA     V47                               ; GET BASE 10 EXPONENT OFFSET
...
L9050
        DECA                                      ; SUBTRACT ONE (DECIMAL POINT)
        JSR     L90EA                             ; PUT ACCA ZEROES INTO BUFFER (TRAILING ZEROES)
L9054
        JSR     L9185                             ; INSERT ASTERISK PADDING, FLOATING $, AND POST-SIGN
...
L9060
        CLR     ,U                                ; CLEAR THE LAST CHARACTER IN THE BUFFER
;*
...
L9065
        LEAX    $01,X                             ; MOVE BUFFER POINTER UP ONE
...
L907C
        PSHS    A                                 ; PUSH A CHARACTER ONTO THE STACK
...
L9096
        PULS    A                                 ; * PULL A CHARACTER OFF OF THE STACK
...
L90B8
        ADDA    V47                               ; *ADD THE BASE 10 EXPONENT OFFSET - ACCA CONTAINS THE
...
L90BD
        PSHS    A                                 ; SAVE INITIAL SHIFT COUNTER ON THE STACK
L90BF
        BPL     L90CB                             ; EXIT ROUTINE IF POSITIVE
...
L90CB
        LDA     V47                               ; * GET BASE 10 EXPONENT OFFSET, ADD INITIAL SHIFT COUNTER
...
L90EA
        DECA                                      ; DECREMENT ZERO COUNTER
        BPL     L90E2                             ; BRANCH IF NOT DONE
        RTS

L90EE
        LDA     VD9                               ; * GET THE LEFT DIGIT COUNTER AND PUT
...
L90FF
        JSR     L9202                             ; DECODE FPA0 INTO A DECIMAL ASCII STRING
        LDA     VD8                               ; GET THE RIGHT DIGIT COUNTER
        BNE     L9108                             ; BRANCH IF RIGHT DIGIT COUNTER <> 0
        LDU     VARPTR                            ; RESET BUFFER PTR TO THE DECIMAL POINT IF NO DIGITS TO RIGHT
L9108
        ADDA    V47                               ; *ADD BASE 10 EXPONENT - A POSITIVE ACCA WILL CAUSE THAT MANY
...
L911B
        ADDA    VD9                               ; ADD TO THE LEFT DIGIT COUNTER
...
L9129
        ADDA    STRBUF+3                          ; SUBTRACT 1 IF NO POST BYTE FORCE
...
L9130
        BPL     L913C                             ; NO MORE SHIFTS WHEN ACCA >= 0
...
L913C
        LDA     ,S                                ; *GET THE INITIAL VALUE OF THE SHIFT COUNTER
        BMI     L9141                             ; *AND BRANCH IF SHIFTING HAS TAKEN PLACE
        CLRA                                      ; RESET ACCA IF NO SHIFTING HAS TAKEN PLACE
L9141
        NEGA                                      ; *CALCULATE THE POSITION OF THE DECIMAL POINT BY
...
L915A
        LDB     ,S+                               ; GET ORIGINAL EXPONENT OF FPA0
...
L916F
        STA     $01,U                             ; PUT SIGN OF EXPONENT IN STRING BUFFER
...
L9177
        INCA                                      ; ADD ONE TO TENS DIGIT COUNTER
...
L9185
        LDX     #STRBUF+4                         ; POINT X TO START OF PRINT ITEM BUFFER
...
L919E
        PSHS    B                                 ; SAVE FIRST CHARACTER ON STACK
L91A0
        STA     ,X+                               ; STORE PAD CHARACTER IN BUFFER
...
L91B6
        LDA     #'0'                              ; * REPLACE PREVIOUS CHARACTER
        STA     ,-X                               ; * WITH A ZERO
L91BA
        LDA     VDA                               ; * GET STATUS BYTE, CHECK
        BITA    #$10                              ; * FOR FLOATING $
        BEQ     L91C4                             ; * BRANCH IF NO FLOATING $
        LDB     #'$'                              ; * STORE A $ IN
        STB     ,-X                               ; * BUFFER
L91C4
        ANDA    #$04                              ; CHECK PRE-SIGN FLAG
...
L91E9
        LDX     #LBDBB                            ; POINT X TO FP NUMBER (999,999,999)
        JSR     LBCA0                             ; COMPARE FPA0 TO X
        BGT     L91E4                             ; BRANCH IF FPA0 > 999,999,999
L91F1
        LDX     #LBDB6                            ; POINT X TO FP NUMBER (99,999,999.9)
        JSR     LBCA0                             ; COMPARE FPA0 TO X
...
L9211
        BSR     L9249                             ; CHECK FOR COMMA INSERTION
L9213
        LDA     FPA0+3                            ; * 'ADD' A POWER OF 10 MANTISSA TO FPA0.
...
L9249
        DEC     V45                               ; DECREMENT DECIMAL POINT COUNTER
        BNE     L9256                             ; NOT TIME FOR DECIMAL POINT
L924D
        STU     VARPTR                            ; SAVE BUFFER POINTER-POSITION OF THE DECIMAL POINT
        LDA     #'.'                              ; * STORE A DECIMAL
...
;*                             ; * DECREMENTS BEFORE ANOTHER COMMA WILL BE INSERTED
        RTS
L9256
        DEC     VD7                               ; DECREMENT COMMA COUNTER
...
L9263
        LDA     V47                               ; GET THE BASE 10 EXPONENT OFFSET
...
L926A
        SUBA    #$03                              ; * DIVIDE DECIMAL POINT COUNTER BY 3; LEAVE
...
L9281
        DECA                                      ; * DECREMENT ZEROES COUNTER AND
