...
1430 PRINT:IF T0<>T THEN 1490
1460 PRINT "YOUR MISSION BEGINS WITH YOUR STARSHIP LOCATED"
1470 PRINT "IN THE GALACTIC QUADRANT, '";:GOSUB 9030: PRINT "'.":GOTO 1500
1490 PRINT "NOW ENTERING ";:GOSUB 9030:PRINT " QUADRANT . . ."
...
1600 FOR I=1 TO 3:K(I,3)=0:NEXT I:Q$=""
...
2061 IF A$="NAV" THEN 2300
2062 IF A$="SRS" THEN 1980
2063 IF A$="LRS" THEN 4000
2064 IF A$="PHA" THEN 4260
2065 IF A$="TOR" THEN 4700
2066 IF A$="SHE" THEN 5530
2067 IF A$="DAM" THEN 5690
2068 IF A$="COM" THEN 7290
2069 IF A$="XXX" THEN 6720
...
5920 GOSUB 8790:PRINT INT(D(R1)*100)*.01
...
6140 R1=FNR(1):D(R1)=D(R1)-H/S-.5*RND(0)
6170 PRINT "DAMAGE CONTROL REPORTS ";
6171 GOSUB 8790: PRINT " DAMAGED BY THE HIT'"
6200 NEXT I:RETURN
...
7700 PRINT Z(I,J)+1000;
7720 NEXT J:GOTO 7850
7740 Z4=I:Z5=1:GOSUB 9030
7800 Z5=5:GOSUB 9030
...
8792 PRINT "WARP ENGINES"; :RETURN
8794 PRINT "SHORT RANGE SENSORS"; :RETURN
8796 PRINT "LONG RANGE SENSORS"; :RETURN
8798 PRINT "PHASER CONTROL"; :RETURN
8800 PRINT "PHOTON TUBES"; :RETURN
8802 PRINT "DAMAGE CONTROL"; :RETURN
8804 PRINT "SHIELD CONTROL"; :RETURN
8806 PRINT "LIBRARY-COMPUTER"; :RETURN
...
8900 Z3=1:RETURN
9010 REM QUADRANT NAME FROM Z4,Z5 (=Q1,Q2)
9020 REM CALL WITH G5=1 TO GET REGION NAME ONLY
9030 IF Z5<=4 THEN ON Z4 GOTO 9040,9050,9060,9070,9080,9090,9100,9110
9035 GOTO 9120
9040 PRINT "ANTARES"; :GOTO 9210
9050 PRINT "RIGEL"; :GOTO 9210
9060 PRINT "PROCYON"; :GOTO 9210
9070 PRINT "VEGA"; :GOTO 9210
9080 PRINT "CANOPUS"; :GOTO 9210
9090 PRINT "ALTAIR"; :GOTO 9210
9100 PRINT "SAGITTARIUS"; :GOTO 9210
9110 PRINT "POLLUX"; :GOTO 9210
9120 ON Z4 GOTO 9130,9140,9150,9160,9170,9180,9190,9200
9130 PRINT "SIRIUS"; :GOTO 9210
9140 PRINT "DENEB"; :GOTO 9210
9150 PRINT "CAPELLA"; :GOTO 9210
9160 PRINT "BETELGEUSE"; :GOTO 9210
9170 PRINT "ALDEBARAN"; :GOTO 9210
9180 PRINT "REGULUS"; :GOTO 9210
9190 PRINT "ARCTURUS"; :GOTO 9210
9200 PRINT "SPICA";
9210 IF G5<>1 THEN ON Z5 GOTO 9230,9240,9250,9260,9230,9240,9250,9260
9220 RETURN
9230 PRINT " I"; :RETURN
9240 PRINT " II"; :RETURN
9250 PRINT " III"; :RETURN
9260 PRINT " IV"; :RETURN
