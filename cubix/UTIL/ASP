...
NORVAR	SSR	4		POINT TO VARIABLE
	LBSR	CRSYM		CREATE SYMBOL
	LDA	TEMP		GET DATA TYPE
	STA	,X+		SAVE IT
	LBSR	SKIP		GET NEXT
...
*
LOOKUP	SSR	4		ADVANCE TO SYMBOL
...
* GET NEXT TOKEN SET
GETOK	SSR	4		SKIP TO NEXT TOKEN
	BEQ	TOK		END OF LINE, QUIT
	CMPA	#'('		STARTING BRACE?
