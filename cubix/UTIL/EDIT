...
QERR	SSR	24		DISPLAY MSG
	FCCZ	/Invalid Qualifier: '/
	LDA	,Y+		GET CHAR
DSQU1	SSR	33		DISPLAY
	SSR	5		TEST FOR TERMINATOR
	BEQ	GOABO		YES, EXIT
	CMPA	#'/'		NEXT QUALIFIER?
