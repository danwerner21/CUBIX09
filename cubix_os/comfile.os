...
NEWLIN
        LDX     #INBUFF                           ;PT TO BUFFER
REDCHR
        JSR     RCCHR                             ;READ CHAR FROM CMD FILE
...
CEXIT
        ...
        STB     >CMDRC                            ;SET IT
CEXI
        JMP     CMDEOF                            ;END OF FILE
;* EXECUTE DOS COMMAND
EXDCOM
        LDX     >CMDOFF                           ;GET OFFSET
