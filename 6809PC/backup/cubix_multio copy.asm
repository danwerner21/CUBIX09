...
KBD_PUTCMD0:
        ...
        EORB    #$02                              ; FLIP IT FOR APPROPRIATE RETURN VALUES
        BNE     KBD_PUTCMD1                       ; EMPTY, GO TO WRITE
...
KBD_PUTDATA0:
        ...
        ANDB    #$02                              ; ISOLATE OUTPUT EMPTY BIT
        EORB    #02                               ; FLIP IT FOR APPROPRIATE RETURN VALUES
        BNE     KBD_PUTDATA1                      ; EMPTY, GO TO WRITE
        JSR     DELAY                             ; WAIT A BIT
        DEX
...
KBD_DEC5A:
        LDA     KBD_MAPEXT,X+                   ; GET FIRST BYTE OF PAIR FROM EXT MAP TABLE AND INX
        CMP     #$00                               ; END OF TABLE?
        BEQ     KBD_DECNEW                      ; UNKNOWN OR BOGUS, START OVER
...
KBD_DEC7:                                         ; COMPLETE PROCESSING OF EXTENDED AND KEY BREAK EVENTS
        ...
        BNE      KBD_DECNEW                     ; PROCESS NEXT KEY
...
KBD_DEC10:                                        ; ADJUST KEYCODE FOR CAPS LOCK
        ...
        CMP      #$7b                           ; COMPARE TO LOWERCASE Z+1
...
KBD_DEC10A:
        ...
        BLT     C,KBD_DEC11                       ; BELOW IT, BYPASS
...
KBD_DEC11:                                        ; HANDLE NUM PAD KEYS
        ...
        ORA      #BD_NUMPAD                        ; TURN ON THE NUMPAD BIT
        STA      KBD_STATE                     ; SAVE IT
