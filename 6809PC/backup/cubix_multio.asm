...
;__________________________________________________________________________________________________
;
KBD_SCANCODE	FCB	0	; RAW SCANCODE
KBD_KEYCODE	FCB	0	; RESULTANT KEYCODE AFTER DECODING
KBD_STATE	FCB	KBD_DEFSTATE	; STATE BITS (SEE ABOVE)
KBD_LSTATE	FCB	0	; STATE BITS FOR "LEFT" KEYS
KBD_RSTATE	FCB	0	; STATE BITS FOR "RIGHT" KEYS
KBD_STATUS	FCB	0	; CURRENT STATUS BITS (SEE ABOVE)
KBD_REPEAT	FCB	KBD_DEFRPT	; CURRENT REPEAT RATE
KBD_IDLE	FCB	0	; IDLE COUNT
;
;__________________________________________________________________________________________________
