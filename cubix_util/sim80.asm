...
OKEXE	LDX	DRADR,X		GET LOAD ADDRESS
	...
	SSR	27		OUTPUT
BUGLF	SSR	22		NEW LINE
BUGGER	SSR	24		OUTPUT PROMPT
	FCCZ	'8080> '	PROMPT
	SSR	3		GET INPUT LINE
	SSR	4		SKIP TO COMMAND
	BEQ	BUGGER		IF NULL, IGNORE
	LDX	#DCMD		POINT TO COMMAND TABLE
	SSR	18		ISSUE COMMAND
...
OTASC	LDA	,Y+		GET DATA
	...
	BRA	ASCEND
UNPRT	LDA	#'.'
ASCEND	SSR	33		OUTPUT
	DECB			BACKUP COUNT
	BNE	OTASC
	SSR	22		NEW LINE
	CMPY	TEMP		OVER END
	BHI	BUG1
	SSR	35		CHECK FOR KEY
	BNE	SHMEM
BUG1	LBRA	BUGGER
* STORE COMMAND
STCMD	DECB			ZIS IT?
...
TRC1	SSR	24		DISPLAY MESSAGE
	FCCZ	'PC='
	TFR	U,D		GET PC
	SSR	27		DISPLAY IN HEX
	SSR	24		MESSAGE
	FCCZ	' OP='
	LDA	,U		GET OPCODE
	SSR	28		OUTPUT
