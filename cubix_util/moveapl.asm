...
MAIN1	LDD	NEWADR		GET NEW ADDRESS
	...
	SSR	78		LOAD THE FILE INTO MEMORY
...
MAIN5	TFR	X,D		SET IT UP
	...
	SSR	68		LOOKUP DIRECTORY ENTRY
	LDD	NEWADR		GET NEW ADDRESS
	STD	DRADR,X		SET IT
	SSR	85		INFORM DOS THAT IT CHANGED
